...
$getUserPurchasedItemsPaidOnce = $Product->getUserPurchasedItemsPaidOnce($data['usertoken']);
if ( $getUserPurchasedItemsPaidOnce ) {
    http_response_code(200);
    $Product->outputData( true, "Fetcehd userdata", $getUserPurchasedItemsPaidOnce );
    exit;
} else {
